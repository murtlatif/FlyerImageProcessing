...
VALID_INPUT_FILE_TYPES = {'.pdf', '.png', '.jpg', '.jpeg'}
...
PROMOTION_WORDS = ['save', 'sale', 'discount', 'up to', 'off', 'promotion', 'bogo', 'buy one get', 'free']

HOLIDAY_WORD_LIST = ['christmas', 'halloween', 'thanksgiving', 'diwali',
                     'easter', 'holiday', 'hanukkah', 'black friday', 'cyber monday', 'st patrick']

MEASUREMENT_WORD_LIST = ['lb', 'lbs', 'oz', 'kg', 'ml', 'g', 'l']
PACKAGE_MEASURE_WORD_LIST = ['box', 'case', 'bag', 'pkg', 'pack', 'package']
